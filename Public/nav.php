...
$is_blog_authenticated = !empty($_SESSION['blog_authenticated']) && $_SESSION['blog_authenticated'] === true;
?>
...
<nav>
    ...
    <ul class="main-nav-list" id="nav_ul">
        ...
        <li><a href="login.php" class="<?php echo ($current_page === 'login.php' || $current_page === 'todo-list.php' || $current_page === 'logout.php') ? 'current_page' : ''; ?>">To-do List</a></li>
    </ul>
